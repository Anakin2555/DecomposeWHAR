...
import numpy as np
from layers.TSVECencoder import TSEncoder
from utils.losses import hierarchical_contrastive_loss
...
class TS2Vec:
    ...
    def fit(self, train_data, n_epochs=None, n_iters=None, verbose=False):
        ...
        if n_iters is None and n_epochs is None:
            n_iters = 200 if train_data.size <= 100000 else 6000  # default param for n_iters
